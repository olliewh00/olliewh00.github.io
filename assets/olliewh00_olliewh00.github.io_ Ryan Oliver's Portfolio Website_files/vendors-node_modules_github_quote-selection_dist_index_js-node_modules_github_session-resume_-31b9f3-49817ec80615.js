...
`)}let y=/\.(gif|png|jpe?g)$/i;function T(e){return y.test(e)}let w=new WeakMap;function E(e,n){var r;w.set(e,(null==(r=null==n?void 0:n.defaultPlainTextPaste)?void 0:r.urlLinks)===!0),e.addEventListener("paste",x)}function x(e){var n,r,a,l;let o,{currentTarget:u}=e,c=null!=(n=w.get(u))&&n,d=s(u);if(!c&&d||c&&!d)return;let h=e.clipboardData;if(!h||!Array.from(h.types).includes("text/plain"))return;let f=e.currentTarget;if(!(f instanceof HTMLTextAreaElement))return;let p=h.getData("text/plain");if(!p||!k(p)||(o=(r=f).selectionStart||0)>1&&"]("===r.value.substring(o-2,o))return;let m=f.value.substring(f.selectionStart,f.selectionEnd);!m.length||k(m.trim())||(e.stopPropagation(),e.preventDefault(),i(f,(a=m,l=p.trim(),`[${a}](${l})`)))}function k(e){try{let n=new URL(e);return S(n.href).trim()===S(e).trim()}catch(e){return!1}}function S(e){return e.endsWith("/")?e.slice(0,e.length-1):e}function C(e){e.addEventListener("dragover",L),e.addEventListener("drop",M),e.addEventListener("paste",A)}function M(e){let n=e.dataTransfer;if(!n||Array.from(n.types).indexOf("Files")>=0)return;let r=H(n);if(!r)return;e.stopPropagation(),e.preventDefault();let a=e.currentTarget;a instanceof HTMLTextAreaElement&&i(a,r)}function L(e){let n=e.dataTransfer;n&&(n.dropEffect="copy")}function A(e){let{currentTarget:n}=e;if(s(n)||!e.clipboardData)return;let r=H(e.clipboardData);if(!r)return;e.stopPropagation(),e.preventDefault();let a=e.currentTarget;a instanceof HTMLTextAreaElement&&i(a,r)}function P(e){return(e.textContent||"").trim().replace(/\|/g,"\\|").replace(/\n/g," ")||"\xa0"}function H(e){if(-1===Array.from(e.types).indexOf("text/html"))return;let n=e.getData("text/html");if(!/<table/i.test(n))return;let r=n.substring(0,n.indexOf("<table")),i=n.lastIndexOf("</table>");if(!r||!i)return;let a=n.substring(i+8),l=new DOMParser().parseFromString(n,"text/html").querySelector("table");if(!(l=!l||l.closest("[data-paste-markdown-skip]")?null:l))return;let o=function(e){let n=Array.from(e.querySelectorAll("tr")),r=n.shift();if(!r)return"";let i=Array.from(r.querySelectorAll("td, th")).map(P),a=i.map(()=>"--"),l=`${i.join(" | ")}
${a.join(" | ")}
`,o=n.map(e=>Array.from(e.querySelectorAll("td")).map(P).join(" | ")).join(`
`);return`
${l}${o}

`}(l);if(o)return[r,o,a].join("").replace(/<meta.*?>/,"")}function O(e){e.addEventListener("paste",I)}function I(e){let{currentTarget:n}=e;if(s(n))return;let r=e.clipboardData;if(!r||!(Array.from(r.types).indexOf("text/x-gfm")>=0))return;let a=e.currentTarget;if(!(a instanceof HTMLTextAreaElement))return;let l=r.getData("text/x-gfm");l&&(e.stopPropagation(),e.preventDefault(),i(a,l))}function W(e,n){for(let r of(e.addEventListener("keydown",l),[C,h,E,O,u]))r(e,n);return e.addEventListener("paste",o),{unsubscribe:()=>{e.removeEventListener("keydown",l),e.removeEventListener("paste",o),e.removeEventListener("dragover",L),e.removeEventListener("drop",M),e.removeEventListener("paste",A),e.removeEventListener("paste",c),e.removeEventListener("dragover",p),e.removeEventListener("drop",f),e.removeEventListener("paste",m),e.removeEventListener("paste",x),e.removeEventListener("paste",I)}}}},46493:(e,n,r)=>{"use strict";r.d(n,{Cj:()=>X,iP:()=>V});let i="less",a="equal",l="greater";var o,s,u,c,d,h,f,p,m,g,v,b,y,T,w,E,x,k=(e,n,r)=>{if(!n.has(e))throw TypeError("Cannot "+r)},S=(e,n,r)=>(k(e,n,"read from private field"),r?r.call(e):n.get(e)),C=(e,n,r)=>{if(n.has(e))throw TypeError("Cannot add the same private member more than once");n instanceof WeakSet?n.add(e):n.set(e,r)},M=(e,n,r,i)=>(k(e,n,"write to private field"),i?i.call(e,r):n.set(e,r),r),L=(e,n,r)=>(k(e,n,"access private method"),r);let MinHeap=class MinHeap{constructor({compareFn:e}){C(this,u),C(this,d),C(this,o,void 0),C(this,s,void 0),M(this,o,e),M(this,s,[])}insert(e){S(this,s).push(e),L(this,d,h).call(this)}pop(){let e=S(this,s)[0];return S(this,s)[S(this,s).length-1]&&(S(this,s)[0]=S(this,s)[S(this,s).length-1],S(this,s).pop()),L(this,u,c).call(this),e}peek(){return S(this,s)[0]}delete(e){let n=S(this,s).indexOf(e);-1!==n&&(P(S(this,s),n,S(this,s).length-1),S(this,s).pop(),L(this,u,c).call(this))}clear(){M(this,s,[])}get size(){return S(this,s).length}};function A(e){return Math.floor((e-1)/2)}function P(e,n,r){let i=e[n];e[n]=e[r],e[r]=i}o=new WeakMap,s=new WeakMap,u=new WeakSet,c=function(){let e=0;for(;2*e+1<S(this,s).length;){var n,r;let a=2*e+1;if(2*e+2<S(this,s).length&&S(this,o).call(this,(n=S(this,s),n[2*e+2]),(r=S(this,s),r[2*e+1]))===i&&(a=2*e+2),S(this,o).call(this,S(this,s)[e],S(this,s)[a])===i)break;P(S(this,s),e,a),e=a}},d=new WeakSet,h=function(){var e;let n=S(this,s).length-1;for(;n>0&&S(this,o).call(this,S(this,s)[n],(e=S(this,s),e[A(n)]))===i;)P(S(this,s),n,A(n)),n=A(n)};var H=Object.defineProperty,O=(e,n,r)=>{if(!n.has(e))throw TypeError("Cannot "+r)},I=(e,n,r)=>(O(e,n,"read from private field"),r?r.call(e):n.get(e)),W=(e,n,r)=>{if(n.has(e))throw TypeError("Cannot add the same private member more than once");n instanceof WeakSet?n.add(e):n.set(e,r)},D=(e,n,r,i)=>(O(e,n,"write to private field"),i?i.call(e,r):n.set(e,r),r);let Deferred=class Deferred{constructor(){((e,n,r)=>{let i;return(i="symbol"!=typeof n?n+"":n)in e?H(e,i,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[i]=r})(this,f,"Deferred"),W(this,p,void 0),W(this,m,void 0),W(this,g,void 0),D(this,p,new Promise((e,n)=>{D(this,m,e),D(this,g,n)}))}then(e,n){return Promise.prototype.then.apply(I(this,p),[e,n])}catch(e){return Promise.prototype.catch.apply(I(this,p),[e])}finally(e){return Promise.prototype.finally.apply(I(this,p),[e])}resolve(e){I(this,m).call(this,e)}reject(e){I(this,g).call(this,e)}getPromise(){return I(this,p)}};f=Symbol.toStringTag,p=new WeakMap,m=new WeakMap,g=new WeakMap;var _=(e,n,r)=>{if(!n.has(e))throw TypeError("Cannot "+r)},$=(e,n,r)=>(_(e,n,"read from private field"),r?r.call(e):n.get(e)),j=(e,n,r)=>{if(n.has(e))throw TypeError("Cannot add the same private member more than once");n instanceof WeakSet?n.add(e):n.set(e,r)},F=(e,n,r,i)=>(_(e,n,"write to private field"),i?i.call(e,r):n.set(e,r),r),R=(e,n,r)=>(_(e,n,"access private method"),r);let LiveRegionElement=class LiveRegionElement extends HTMLElement{constructor(){if(super(),j(this,T),j(this,E),j(this,v,void 0),j(this,b,void 0),j(this,y,void 0),!this.shadowRoot){const e=(q||((q=document.createElement("template")).innerHTML=B),q);this.attachShadow({mode:"open"}).appendChild(e.content.cloneNode(!0))}F(this,v,!1),F(this,y,null),F(this,b,new MinHeap({compareFn:z}))}get delay(){let e=this.getAttribute("delay");return e?parseInt(e,10):150}set delay(e){this.setAttribute("delay",`${e}`)}announce(e,n={}){let{delayMs:r,politeness:i="polite"}=n,a=Date.now(),l=new Deferred,o={deferred:l,politeness:i,contents:e,scheduled:void 0!==r?a+r:a};return $(this,b).insert(o),R(this,T,w).call(this),{...l.getPromise(),cancel:()=>{$(this,b).delete(o),l.resolve()}}}announceFromElement(e,n){var r;let i,a=(i="",(r=e).hasAttribute("aria-label")?i=r.getAttribute("aria-label"):r.innerText?i=r.innerText:r.textContent&&(i=r.textContent),i?i.trim():"");return""!==a?this.announce(a,n):{...Promise.resolve(),cancel:U}}getMessage(e="polite"){let n=this.shadowRoot?.getElementById(e);if(!n)throw Error("Unable to find container for message");return n.textContent}clear(){null!==$(this,y)&&(clearTimeout($(this,y)),F(this,y,null)),$(this,b).clear()}};v=new WeakMap,b=new WeakMap,y=new WeakMap,T=new WeakSet,w=function(){if($(this,v))return;let e=$(this,b).peek();if(!e)return;null!==$(this,y)&&(clearTimeout($(this,y)),F(this,y,null));let n=Date.now();if(e.scheduled<=n){(e=$(this,b).pop())&&R(this,E,x).call(this,e),R(this,T,w).call(this);return}let r=e.scheduled-n;F(this,y,window.setTimeout(()=>{F(this,y,null),R(this,T,w).call(this)},r))},E=new WeakSet,x=function(e){F(this,v,!0);let{contents:n,deferred:r,politeness:i}=e,a=this.shadowRoot?.getElementById(i);if(!a)throw F(this,v,!1),Error(`Unable to find container for message. Expected a container with id="${i}"`);a.textContent===n?a.textContent=`${n}\xa0`:a.textContent=n,null!==$(this,y)&&clearTimeout($(this,y)),r.resolve(),this.delay>0?F(this,y,window.setTimeout(()=>{F(this,y,null),F(this,v,!1),R(this,T,w).call(this)},this.delay)):(F(this,y,null),F(this,v,!1),R(this,T,w).call(this))};let q=null,B=`
<style>
:host {
  clip-path: inset(50%);
  height: 1px;
...
//# sourceMappingURL=vendors-node_modules_github_quote-selection_dist_index_js-node_modules_github_session-resume_-31b9f3-59a9e1d60489.js.map